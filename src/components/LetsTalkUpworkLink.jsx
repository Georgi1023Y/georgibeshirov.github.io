...
const base =
  "inline-flex min-h-[44px] shrink-0 items-center justify-center gap-2 rounded-ds-full bg-[#14a800] px-4 py-2 text-xs font-semibold text-white shadow-md shadow-[#14a800]/25 ring-2 ring-[#14a800]/20 transition duration-200 ease-out hover:-translate-y-0.5 hover:bg-[#118f00] hover:shadow-lg hover:shadow-[#14a800]/30 active:translate-y-0 md:px-6 md:py-2.5 md:text-sm";
