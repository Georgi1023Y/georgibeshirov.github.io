...
const cardLight =
  "rounded-ds-xl border border-slate-200/90 bg-slate-50/40 p-6 shadow-sm backdrop-blur-sm";
...
const AsynchronousWorkflow = () => {
  return (
    <section
      id="async-workflow"
      className="w-full min-w-0 max-w-full overflow-x-hidden border-t border-slate-200/80 bg-white px-gutter py-16 text-slate-900 dark:border-slate-700/60 dark:bg-[#020617] sm:py-20 sm:px-gutter-sm lg:px-gutter-lg"
    >
      <div className="mx-auto w-full max-w-content min-w-0">
        <motion.h2
          ...
          className="mb-4 text-center font-display text-3xl font-bold text-slate-900 dark:text-slate-50 sm:text-4xl"
        >
        ...
        <motion.p
          ...
          className="mx-auto mb-12 max-w-3xl text-center text-pretty text-base leading-relaxed text-slate-600 dark:text-slate-300 sm:text-lg"
        >
        ...
        <div className="grid gap-6 md:grid-cols-3 lg:gap-8">
          {pillars.map((item, i) => (
            ...
            >
              ...
              <h3 className="mb-2 font-display text-lg font-semibold text-slate-900 dark:text-slate-50">
                {item.title}
              </h3>
